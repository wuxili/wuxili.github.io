...
-->
    ...
    <title>Single Player Performance ScatterPlot</title>
    <meta name="description" content="Single player scatter plot">
    ...
    <div class="container">
        ...
        <header class="sixteen columns">
            <div id="logoDetailView">
                <h1>Single Player Performance ScatterPlot</h1>
            </div>
            <nav>
                <ul>
		...
		<?php include('single_player_stats_relation.php') ?>
