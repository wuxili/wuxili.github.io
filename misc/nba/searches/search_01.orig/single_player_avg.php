...
<form action="single_player_avg_response.php" method="GET">
	<p>
	...
	<?php // add player to each tab
		...
		foreach ($letters as $l) { // add all players that last name start with letter $l
			...
			while($row = mysqli_fetch_array($result)) {
				...
				print "<a href='./single_player_avg_response.php?player_name=$player_name'>$player_name</a><br />";
			}
			print "</div>";
...
<?php include ("single_player_avg_footer.php") ?>
