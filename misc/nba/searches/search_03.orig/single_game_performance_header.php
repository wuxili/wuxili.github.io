...
<head>
	...
	<style type="text/css">
	.textbox { border:0; color:#f6931f; font-weight:bold; font-size:16px; }
	...
	#slider_fg_pct { float:left; clear:left; width:200px; margin:15px; }
	...
	#slider_fg3 { float:left; clear:left; width:200px; margin:15px; }
	...
	#slider_fg3a { float:left; clear:left; width:200px; margin:15px; }
	...
	#slider_fg3_pct { float:left; clear:left; width:200px; margin:15px; }
	...
	#slider_ft_pct { float:left; clear:left; width:200px; margin:15px; }
